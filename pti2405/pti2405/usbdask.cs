...
public class USBDASK
{
    ...
    public const ushort NUM_MODULE_TYPE           = 9;
...
// Trigger Edge (bit14)
    ...
    public const ushort UD_AI_Gate_ActiveHigh     = 0x4000;
    public const ushort UD_AI_Gate_ActiveLow      = 0x0000;
...
// Flag for AO Waveform Seperation Interval 
    ...
    // Gated Trigger Level  
    public const ushort P2405_AI_Gate_ActiveHigh            = 0x0004;
    public const ushort P2405_AI_Gate_ActiveLow            = 0x0000;
...
/*---------------------------------------------------------------------------*/
    ...
    [DllImport(UDDASK_DLL_FILE_NAME)]
    public static extern short UD_Serial_Number_Read(ushort wCardNumber, byte[] SerialNum);
